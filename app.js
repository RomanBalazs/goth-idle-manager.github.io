...
index 1d9df64c4b27ca14dd7e7a128c591079a0814242..6fe55d58d0934b5d6d1fc0da942a13fd58bc9b8c 100644
--- a/app.js
+++ b/app.js
@@ -94,50 +94,590 @@ const BADGES = [
     id: "manager10",
     icon: "🧑‍💼",
     name: "HR Horror",
     desc: "Vásárolj 10 menedzser szintet.",
...
+);
 ...
 const WORLD_CONFIGS = [
@@ -428,141 +968,169 @@ const defaultState = {
   gothGirlLiquids: {
     uncommon: 0,
     common: 0,
     rare: 0,
...
@@ -599,50 +1167,69 @@ function fxBanner(text, variant = 'info') {
   el.textContent = text;
   host.appendChild(el);
...
@@ -753,125 +1340,247 @@ function loadState() {
...
@@ -981,50 +1690,99 @@ function renderProfile() {
...
@@ -1464,50 +2222,53 @@ function renderWorkplaces() {
...
@@ -1611,206 +2372,217 @@ function renderUpgrades() {
...
@@ -1936,74 +2708,83 @@ function addLiquids(results) {
...
@@ -2017,70 +2798,73 @@ function updateTopBar() {
...
@@ -2339,85 +3123,90 @@ function refreshDerivedQuestProgress() {
...
@@ -2439,94 +3228,98 @@ function renderQuestList(listEl, scope, quests) {
     })
     .join("");
